...
export interface PreAuthPayload {
  ...
  /**
   * ผ่านมาได้เพราะเป็นเครื่องที่จำไว้ ไม่ได้กรอก OTP จริงในรอบนี้
   *
   * ใช้เพื่อบันทึก log ให้ตรงความจริงเท่านั้น (LOGIN_TRUSTED แทน LOGIN)
   * ไม่ได้ใช้ตัดสินสิทธิ์อะไร — totpVerified เป็นตัวตัดสินสิทธิ์ตัวเดียว
   */
  viaTrustedDevice?: boolean;
  /**
   * ผู้ใช้ติ๊ก "จำอุปกรณ์นี้" ไว้ตอนกรอก OTP
   *
   * ต้องพกต่อมาถึงขั้นเปลี่ยนรหัสผ่าน เพราะขั้นนั้นเพิกถอนอุปกรณ์ทุกเครื่อง
   * (สเปกข้อ 6.1) ถ้าไม่พกมา การติ๊กของผู้ใช้จะถูกลบทิ้งทันทีโดยไม่มีอะไรบอก
   */
